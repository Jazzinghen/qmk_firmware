...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  KC_DEL,  KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  _______, _______, KC_MHEN, KC_HENK, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
