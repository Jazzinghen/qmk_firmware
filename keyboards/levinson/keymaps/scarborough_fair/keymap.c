 ...
 * |------+------+------+------+------+------|   |------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  | Kana |Lower |Space |   |Space |Raise |   /  | Left | Down |Right |
 * `-----------------------------------------'   `-----------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_KANA, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT \
),
 ...
 * |   ~  |   !  |   @  |   #  |   $  |   %  |   |   ^  |   &  |   *  |   (  |   )  | Bksp |
 * |------+------+------+------+------+------|   |------+------+------+------+------+------|
 * | Del  | Prev |Pl/Pau| Next |      |      |   |      |   _  |   +  |   {  |   }  |Enter |
 * |------+------+------+------+------+------|   |------+------+------+------+------+------|
 * |      |      | Vol- | Vol+ |      |      |   |      |      |      |      | PgUp |  |   |
 * |------+------+------+------+------+------|   |------+------+------+------+------+------|
 * |      |      |MuHen | Hen  |      |      |   |      |      |      | Home |PgDown| End  |
 * `-----------------------------------------'   `-----------------------------------------'
 */
[_LOWER] = LAYOUT_ortho_4x12( \
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, \
  KC_DEL,  KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, \
  _______, _______, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_PIPE, \
  _______, _______, KC_MHEN, KC_HENK, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_END   \
),
