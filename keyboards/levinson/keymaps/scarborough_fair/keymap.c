 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   |   N  |   M  |   ,  |   .  |   /  |  "   |
 * |------+------+------+------+------+------|   |------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  | Kana |Lower |Space |   |Space |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------'   `-----------------------------------------'
 */
...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  KC_DEL,  KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______, \
  _______, _______, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, _______, _______, KC_BSLS, \
  _______, _______, KC_MHEN, KC_HENK, _______, _______, _______, _______, _______, _______, _______, _______  \
),
