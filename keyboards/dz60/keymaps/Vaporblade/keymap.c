/*
 * 2018 Michele Bianchi
 */

#include QMK_KEYBOARD_H

#undef PRODUCT
#define PRODUCT         Vaporblade
#undef DESCRIPTION
#define DESCRIPTION     Next generation Pok3r
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------------------------------------+
   * | Ctrl |  GUI  |  Alt  |              Space                | RAlt  |  FN  |  ADJ |  RCtrl |
   * `-----------------------------------------------------------------------------------------'
   */
  ...
  [_QWERTY] = LAYOUT(
      ...
      KC_LCTL,  KC_LGUI,  KC_LALT,  KC_SPC, KC_SPC, KC_SPC, KC_RALT,  MO(_FN),  XXXXXXX,  MO(_ADJUST),  KC_RCTL
      ),
