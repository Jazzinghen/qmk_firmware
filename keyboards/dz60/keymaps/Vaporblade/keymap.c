...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------------------------------------+
   * |  FN  |  GUI  |  Alt  |              Space                | RAlt  | ZKHK |  ADJ |  RCtrl |
   * `-----------------------------------------------------------------------------------------'
   */
  ...
  [_QWERTY] = LAYOUT(
      ...
      MO(_FN),  KC_LGUI,  KC_LALT,  KC_SPC, KC_SPC, KC_SPC, KC_RALT,  LALT(KC_ZKHK),  XXXXXXX,  MO(_ADJUST),  KC_RCTL
      ),
   ...
   * |-----------------------------------------------------------------------------------------+
   * |         |Vol- |Mute |Vol+ |     |     |     |Left |Down|Right |PGDwn| End |             |
   * |-----------------------------------------------------------------------------------------+
   * |           |     |     |     |     |     |     |     |     |     |     |                 |
   * |-----------------------------------------------------------------------------------------+
   * |      |       |       |                                   |       |      |      |        |
  ...
  [_FN] = LAYOUT(
      ...
      _______, KC_VOLD, KC_MUTE, KC_VOLU, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDOWN, KC_END,  _______,
