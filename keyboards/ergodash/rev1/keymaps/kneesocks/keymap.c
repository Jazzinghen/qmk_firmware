...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SPC ,                        KC_SPC , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_RSFT, \
    ADJUST,  KC_LGUI, KC_LALT, KC_ALGR,          FUNC,    KC_SPC ,KC_SPC,          KC_SPC,KC_SPC , KC_ENT,           FUNC,    KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
