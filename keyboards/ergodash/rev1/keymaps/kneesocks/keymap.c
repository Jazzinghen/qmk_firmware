...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | ADJ  |  GUI |  Alt | AltGr|||||||| FUNC | Enter|      ||||||||      | Space| Enter|||||||| FUNC |Left  | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    F(0),    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MINS,                        KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS, \
    ...
    ADJUST,  KC_LGUI, KC_LALT, KC_ALGR,          FUNC,    KC_ENT ,KC_ENT,          KC_SPC,KC_SPC , KC_ENT,           FUNC,    KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
  ...
  [_FUNCTION] = LAYOUT(
    ...
    _______, _______, _______, _______,          _______, _______, _______,      _______, _______, _______,          _______, KC_HOME, KC_PGDOWN, KC_END \
  ),
